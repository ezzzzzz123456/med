...
import DiseaseChat from './pages/DiseaseChat'; // <--- ADDED THIS IMPORT
        ...
        <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
          ...
          <div className="fade-in"> 
            <Routes>
              ...
              <Route path="/analyze" element={<DiseaseChat />} /> {/* <--- ADDED THIS ROUTE */}
    ...
    <nav className="bg-gradient-to-r from-slate-50 via-cyan-700 to-cyan-950 shadow-lg sticky top-0 z-50 transition-all">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-2">
          ...
          <NavLink to="/analyze" label="Symptom Analyzer" /> {/* <--- ADDED TO NAVBAR */}
